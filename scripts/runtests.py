...
TEST_CASES = [
    ...
    TestCase(NODE_TEST, 'test_maxpool_2d_same_lower'),
    TestCase(NODE_TEST, 'test_maxpool_2d_same_upper'),
    ...
    TestCase(NODE_TEST, 'test_averagepool_2d_precomputed_same_upper'),
    ...
    TestCase(NODE_TEST, 'test_averagepool_2d_same_lower'),
    TestCase(NODE_TEST, 'test_averagepool_2d_same_upper'),
